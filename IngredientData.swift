...
class Data {
    class func getData() -> [IngredientClass] {
        ...
        data.append(IngredientClass(ingredientName: "Cheese, cottage", ingredientIcon: "cheese", emissionsPerKg: 0.2645544, standardPortionName: "tbsp", standardPortionSizeKg: 0.02))
        data.append(IngredientClass(ingredientName: "Cheese, Feta", ingredientIcon: "", emissionsPerKg: 5.81, standardPortionName: "serving", standardPortionSizeKg: 0.03))
        data.append(IngredientClass(ingredientName: "Cheese, haloumi", ingredientIcon: "", emissionsPerKg: 5.81, standardPortionName: "serving", standardPortionSizeKg: 0.05))
        data.append(IngredientClass(ingredientName: "Cheese, Hard", ingredientIcon: "", emissionsPerKg: 8.3, standardPortionName: "slice", standardPortionSizeKg: 0.03))
        data.append(IngredientClass(ingredientName: "Cheese, Mozzarella", ingredientIcon: "", emissionsPerKg: 5.81, standardPortionName: "slice", standardPortionSizeKg: 0.03))
